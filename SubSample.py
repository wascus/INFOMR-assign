...
# Function to process all OBJ files in the HeavilySampled folder
def process_heavily_sampled_models(root_folder):
...
if __name__ == "__main__":
    ...
    # Start processing the HeavilySampled folder
    process_heavily_sampled_models(heavily_sampled_folder)
